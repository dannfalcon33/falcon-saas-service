  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-blue-500/30">
      <div className="relative grid min-h-screen lg:grid-cols-2">
        ...
        {/* COLUMNA IZQUIERDA */}
        <section className="relative hidden border-r border-white/5 lg:flex lg:flex-col lg:justify-between lg:px-12 lg:py-12 xl:px-20 bg-black/20 backdrop-blur-sm shadow-2xl">
          ...
          <div className="max-w-xl mx-auto space-y-12">
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="flex flex-col lg:flex-row items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/50 font-medium font-serif opacity-80">Control Total y Continuidad IT</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-md mx-auto lg:mx-0 text-base leading-relaxed text-white/60 xl:text-lg italic font-serif">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                { title: "Tickets y Soporte", desc: "Gestión de tickets.", icon: Ticket },
                { title: "Mantenimiento", desc: "Control de visitas.", icon: ClipboardCheck },
                { title: "Continuidad", desc: "Salud de servidores.", icon: Activity },
              ].map((item) => (
                <div key={item.title} className="rounded-3xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-xl hover:bg-white/[0.06] transition-colors group text-center">
                  ...
                  <p className="text-xs leading-relaxed text-white/50 font-medium">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="relative flex min-h-screen items-center justify-center px-6 py-10 sm:px-8 lg:px-16 xl:px-24 overflow-hidden">
          <div className="w-full max-w-md mx-auto relative z-10">
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              ...
              >
                <div className="absolute inset-0 bg-linear-to-r from-transparent via-black/5 to-transparent skew-x-[-20deg] translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                <span className="flex items-center justify-center gap-2">
                  {isLoading ? "Validando accesos..." : "Acceder al Panel"} <ArrowRight className={`w-4 h-4 ${isLoading ? 'animate-pulse' : ''}`} />
                </span>
              </button>
            </form>
            ...
            <div className="mt-12 space-y-4">
              <div className="flex items-start gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/5 transition-all hover:bg-white/[0.04] group">
                ...
                <div>
                  <h4 className="text-[10px] font-black text-white uppercase tracking-[0.2em]">Acceso Seguro</h4>
                  <p className="mt-2 text-[11px] leading-relaxed text-white/30 font-medium tracking-tight">Datos cifrados de grado empresarial.</p>
                </div>
              </div>
              ...
              <div className="text-center mt-10">
                <p className="text-xs font-medium text-white/30 tracking-widest uppercase">
                  ...
                  <button 
                    ...
                    className="font-black text-white hover:text-blue-300 hover:underline underline-offset-4"
                  >
                    Solicitar acceso
                  </button>
                </p>
